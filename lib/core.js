...
var PlotData = /** @class */ (function () {
    ...
    PlotData.prototype.refresh_axis = function (nb_axis) {
        if (this.vertical === true) {
    ...
    PlotData.prototype.add_to_value_list = function (to_disp_attributes) {
    ...
    PlotData.prototype.mouse_interaction = function (parallelplot) {
        ...
        canvas.addEventListener('mousedown', function (e) {
            ...
            if (parallelplot) {
                _b = _this.initialize_click_on_axis(_this.value_list.length, mouse1X, mouse1Y, click_on_axis), click_on_axis = _b[0], selected_axis_index = _b[1];
                _c = _this.initialize_click_on_name(_this.value_list.length, mouse1X, mouse1Y), click_on_name = _c[0], selected_name_index = _c[1];
...
var ParallelPlot = /** @class */ (function (_super) {
    ...
    function ParallelPlot(data, width, height, coeff_pixel) {
        ...
        for (var i_1 = 0; i_1 < to_disp_attribute_names.length; i_1++) {
            for (var j = 0; j < _this.attribute_list.length; j++) {
                if (to_disp_attribute_names[i_1] == _this.attribute_list[j]['name']) {
                    to_disp_attributes.push(_this.attribute_list[j]);
                }
            }
        }
        _this.add_to_value_list(to_disp_attributes);
        _this.initialize_data_lists();
        var nb_axis = _this.value_list.length;
        if (nb_axis <= 1) {
            throw new Error('At least 2 axis are required');
        }
        ;
        _this.refresh_axis(nb_axis);
