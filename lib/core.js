...
var ParallelPlot = /** @class */ (function (_super) {
    ...
    function ParallelPlot(data, width, height, coeff_pixel) {
        ...
        _this.initialize_data_lists(attribute_list);
    ...
    ParallelPlot.prototype.initialize_data_lists = function (attribute_list) {
