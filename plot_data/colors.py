...
ROSE = Color.dict_to_object('rgb(255,105,180)')  # Vocabulary
LIGHTROSE = Color.dict_to_object('rgb(255,192,203)')  # Vocabulary
PINK = Color.dict_to_object('rgb(255,105,180)')
LIGHTPINK = Color.dict_to_object('rgb(255,192,203)')
VIOLET = Color.dict_to_object('rgb(238,130,238)')  # Vocabulary
LIGHTVIOLET = Color.dict_to_object('rgb(234,165,246)')  # Vocabulary
PURPLE = Color.dict_to_object('rgb(238,130,238)')
LIGHTPURPLE = Color.dict_to_object('rgb(234,165,246)')
