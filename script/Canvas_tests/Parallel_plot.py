...
color_fills = ['violet', 'blue', 'green', 'red']
...
parallel_plot = plot_data.ParallelPlot(elements=elements, attribute_list=attribute_list, line_color=line_color, line_width=line_width)
