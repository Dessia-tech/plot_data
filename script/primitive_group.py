...
contour = plot_data.Contour2D(plot_data_primitives=[plot_data.LineSegment2D([1, 1], [1, 2]),
                              ...
                              surface_style=plot_data.SurfaceStyle(colors.LIGHTORANGE, hatching=hatching))
...
plot_data_object = plot_data.PrimitiveGroup(primitives=[circle2, circle3, circle1, circle4, contour, line1, wire])
